...
eval("document.getElementById('pop').addEventListener('click', function (e) {\n  e.preventDefault();\n  var set = e.currentTarget.closest('.set');\n  var button = e.currentTarget;\n  var popover = set.querySelector('.popover');\n  set.querySelector('.popover').classList.toggle('show');\n  set.querySelector('.popover').classList.toggle('hide');\n  popover.style.left = \"\".concat(button.offsetLeft - (popover.offsetWidth - button.offsetWidth) / 2, \"px\");\n  popover.style.top = \"\".concat(button.offsetTop - button.offsetWidth / 2, \"px\");\n});\n\n//# sourceURL=webpack:///./js/app.js?");
